...
gdjs.main4Code.asyncCallback18241508 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.main4Code.asyncCallback18241508(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.main4Code.asyncCallback18235772 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main4Code.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.main4Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.main4Code.asyncCallback18235772(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main4Code.mapOfGDgdjs_9546main4Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main4Code.GDcheck_9595areaObjects1});
gdjs.main4Code.asyncCallback18230476 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main4Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main4Code.asyncCallback18230476(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main4Code.mapOfGDgdjs_9546main4Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main4Code.GDcheck_9595areaObjects1});
gdjs.main4Code.asyncCallback18812388 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main4Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main4Code.asyncCallback18812388(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18260276);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("boca"), gdjs.main4Code.GDbocaObjects1);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18178316);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18227548);
}
}
if (isConditionTrue_0) {
