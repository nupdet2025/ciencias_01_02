...
gdjs.main3Code.asyncCallback18211532 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.main3Code.asyncCallback18211532(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.main3Code.asyncCallback18210916 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main3Code.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.main3Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.main3Code.asyncCallback18210916(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main3Code.mapOfGDgdjs_9546main3Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main3Code.GDcheck_9595areaObjects1});
gdjs.main3Code.asyncCallback18214980 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main3Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main3Code.asyncCallback18214980(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main3Code.mapOfGDgdjs_9546main3Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main3Code.GDcheck_9595areaObjects1});
gdjs.main3Code.asyncCallback18219332 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main3Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main3Code.asyncCallback18219332(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18207556);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18216444);
}
}
if (isConditionTrue_0) {
