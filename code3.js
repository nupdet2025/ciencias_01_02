...
gdjs.main2Code.asyncCallback23098228 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.main2Code.asyncCallback23098228(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.main2Code.asyncCallback23097748 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main2Code.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.main2Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.main2Code.asyncCallback23097748(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main2Code.mapOfGDgdjs_9546main2Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main2Code.GDcheck_9595areaObjects1});
gdjs.main2Code.asyncCallback23101268 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main2Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main2Code.asyncCallback23101268(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.main2Code.mapOfGDgdjs_9546main2Code_9546GDcheck_95959595areaObjects1Objects = Hashtable.newFrom({"check_area": gdjs.main2Code.GDcheck_9595areaObjects1});
gdjs.main2Code.asyncCallback23097020 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.main2Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.9), (runtimeScene) => (gdjs.main2Code.asyncCallback23097020(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23094836);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("bracos"), gdjs.main2Code.GDbracosObjects1);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23099156);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23102444);
}
}
if (isConditionTrue_0) {
